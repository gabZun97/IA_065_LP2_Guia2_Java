...
public class E25_MNRC_ProductoCongeladoPorNitrogeno extends E25_MNRC_ProductoCongelado {
    private String metodoDeCongelacion, tiempoDeExposicionAlNitrogeno;

    public E25_MNRC_ProductoCongeladoPorNitrogeno(String fechaCaducidad, String numeroLote, String fechaDeEnvasado, String paisDeOrigen) {
    ...
    public void setTiempoDeExposicionAlNitrogeno(String tiempoDeExposicionAlNitrogeno) {
