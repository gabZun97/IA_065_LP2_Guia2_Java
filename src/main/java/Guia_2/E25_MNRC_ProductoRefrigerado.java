...
public class E25_MNRC_ProductoRefrigerado extends E25_MNRC_Producto {
    private String codigoSupervisionAlimentaria;
    private String temperaturaDeMantenimientoRecomendada;

    public E25_MNRC_ProductoRefrigerado(String fechaCaducidad, String numeroLote, String fechaDeEnvasado, String paisDeOrigen) {
