...
public class E25_MNRC_ProductoCongelado extends E25_MNRC_Producto {
    private double tempCongelacionRecomendada;

    public E25_MNRC_ProductoCongelado(String fechaCaducidad, String numeroLote, String fechaDeEnvasado, String paisDeOrigen) {
