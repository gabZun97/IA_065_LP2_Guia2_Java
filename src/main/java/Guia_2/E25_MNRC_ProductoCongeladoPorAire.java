...
public class E25_MNRC_ProductoCongeladoPorAire extends E25_MNRC_ProductoCongelado {
    private String composicionDelAire;

    public E25_MNRC_ProductoCongeladoPorAire( String fechaCaducidad, String numeroLote, String fechaDeEnvasado, String paisDeOrigen) {
